...
from .models import HomePage, AboutPage, TeamMember, AboutContentBlock

# Admin Panel Items
class AboutContentBlockInline(SortableTabularInline):
    fields = ['_thumbnail_image_tag', 'image', 'heading', 'content', 'order']
    ...
    def _thumbnail_image_tag(self, obj):
        return mark_safe(f'<img src="{obj.thumbnail.url}" style="max-width: 600px; max-height: 400px" />') if obj.thumbnail else ''
    _thumbnail_image_tag.short_description = 'Content Block Thumbnail Preview'
