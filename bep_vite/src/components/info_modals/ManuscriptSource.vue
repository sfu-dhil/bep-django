<script setup>
import { useManuscriptSourcesStore } from '../../stores/data.js'
...
const object = await useManuscriptSourcesStore().getById(props.objectId)
</script>
...
<template>
  <div class="modal-header align-items-start pb-0">
    <div class="modal-title">
      <figure>
        ...
        <figcaption class="blockquote-footer" v-if="object.call_number" v-html="object.call_number" />
      </figure>
    </div>
  ...
  <div class="modal-body py-0">
    ...
    <dl class="row gy-3 m-0 row-cols-1 row-cols-lg-2">
      ...
      <ObjectModalLinkList label="Archive" modal-type="archive" :objects="[object.archive]" v-if="object.archive" />
  ...
  <div class="modal-footer">
    ...
    <a :href="`/transactions?manuscript_source=${object.id}`" class="btn btn-primary ms-auto">View All Transactions</a>
  </div>
</template>
