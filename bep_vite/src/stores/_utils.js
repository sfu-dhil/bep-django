...
export const _generateSingleFetchApiResourceStore = (resourceApiUrlFunction) => {
  return {
    state: () => ({
      loadedObjects: [],
    }),
...
export const _generateParishDependantApiResourceStore = (parishResourcesApiUrlFunction) => {
  return {
    state: () => ({
      loadedObjects: [],
    }),
